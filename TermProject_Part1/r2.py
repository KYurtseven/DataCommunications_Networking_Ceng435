...
def udp_receiver_for_ack():
	...
	RECV_ACK_SRC_UDP_IP = '10.10.5.1'
	RECV_ACK_SRC_UDP_PORT = 20002

	# ACK messages will be send to this interface and port
	SEND_ACK_DEST_UDP_IP = '10.10.4.1'
	SEND_ACK_DEST_UDP_PORT = 20002

	# We will send ACK messages from this interface and port
	SEND_ACK_SRC_UDP_IP = '10.10.4.2'
	SEND_ACK_SRC_UDP_PORT = 20002
...
def udpserver():
	...
	# r2 listens this connection
	RECV_UDP_IP = '10.10.4.2'
	RECV_UDP_PORT = 10042

	# r2 sends the data to that connection (d)
	SEND_DEST_UDP_IP = '10.10.5.2'
	SEND_DEST_UDP_PORT = 10052

	# r2's udp send address is this
	SEND_SRC_UDP_IP = '10.10.5.1'
	SEND_SRC_UDP_PORT = 10051
	...
	# bind r2's sending interface to this socket
